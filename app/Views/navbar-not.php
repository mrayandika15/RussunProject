...
<nav class="navbar navbar-expand-lg navbar-light nav-russun-not fixed-top">
...
<div class="login-modal-russun clicked-login">
  ...
  <div class="text-center">
    ...
    <div class="form-group-russun">
      <input  type="password" name="password" type="password" id="password" class="form-russun" placeholder="Password">
    </div>
  </div>
